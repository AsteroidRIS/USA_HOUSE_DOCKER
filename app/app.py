...
with open("/home/ris/PycharmProjects/USA_House_Pricing/app/models/knearest.pickle", 'rb') as handle:
    saved_model = pickle.load(handle)

with open('/home/ris/PycharmProjects/USA_House_Pricing/app/models/encoded.pickle', 'rb') as handle:
