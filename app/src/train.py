...
if __name__ == "__main__":
    target = "price"
    train_path = "/app/static/data/train_validate.csv"
    ...
    with open('/app/static/model/encoded.pickle', 'wb') as handle:
    ...
    file_name = "/app/static/model/regression.pickle"
    ...
    print("Saving the model.")
    file_name = "/app/static/model/decision.pickle"
    ...
    print("Saving the model.")
    file_name = '/app/static/model/nearest.pickle'
